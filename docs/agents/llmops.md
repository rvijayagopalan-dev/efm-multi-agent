...
| **Group** | ai-data |
| **Icon** | 🧠 |
| **Expertise** | LLM serving, RAG, prompt management, eval framework |
...
**Focus Area:** LLM serving, RAG, prompt management, eval framework
...
**Typical invocation:**
`
Orchestrator: "This request needs expertise in LLM serving, RAG, prompt management, eval framework"
Tool: invoke_llmops_agent
