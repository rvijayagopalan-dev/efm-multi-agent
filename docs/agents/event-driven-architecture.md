...
| **Icon** | ⚡ |
| **Expertise** | Event streaming, event sourcing, CQRS, Kafka |
...
**Focus Area:** Event streaming, event sourcing, CQRS, Kafka
...
**Typical invocation:**
`
Orchestrator: "This request needs expertise in Event streaming, event sourcing, CQRS, Kafka"
Tool: invoke_event_driven_architecture_agent
