...
| **Group** | ai-data |
| **Icon** | ◇ |
| **Expertise** | Enterprise AI platform, ML infra, responsible AI, AI governance |
...
**Focus Area:** Enterprise AI platform, ML infra, responsible AI, AI governance
...
**Typical invocation:**
`
Orchestrator: "This request needs expertise in Enterprise AI platform, ML infra, responsible AI, AI governance"
Tool: invoke_ai_agent
