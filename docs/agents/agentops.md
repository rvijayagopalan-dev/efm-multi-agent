...
| **Group** | ai-data |
| **Icon** | 🤖 |
| **Expertise** | Agent observability, tracing, eval, CI/CD for agents |
...
**Focus Area:** Agent observability, tracing, eval, CI/CD for agents
...
**Typical invocation:**
`
Orchestrator: "This request needs expertise in Agent observability, tracing, eval, CI/CD for agents"
Tool: invoke_agentops_agent
