...
| **Icon** | 🔄 |
| **Expertise** | Service decomposition, DDD, mesh, resilience |
...
**Focus Area:** Service decomposition, DDD, mesh, resilience
...
**Typical invocation:**
`
Orchestrator: "This request needs expertise in Service decomposition, DDD, mesh, resilience"
Tool: invoke_microservices_architecture_agent
