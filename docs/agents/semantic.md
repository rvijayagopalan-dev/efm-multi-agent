...
| **Group** | enterprise |
| **Icon** | 🔤 |
| **Expertise** | Enterprise ontologies, RDF/OWL, linked data |
...
**Focus Area:** Enterprise ontologies, RDF/OWL, linked data
...
**Typical invocation:**
`
Orchestrator: "This request needs expertise in Enterprise ontologies, RDF/OWL, linked data"
Tool: invoke_semantic_agent
