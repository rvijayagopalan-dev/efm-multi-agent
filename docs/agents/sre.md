...
| **Group** | operations |
| **Icon** | ▷ |
| **Expertise** | SLOs, error budgets, toil elimination, incident management |
...
**Focus Area:** SLOs, error budgets, toil elimination, incident management
...
**Typical invocation:**
`
Orchestrator: "This request needs expertise in SLOs, error budgets, toil elimination, incident management"
Tool: invoke_sre_agent
