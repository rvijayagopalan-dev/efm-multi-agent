...
| **Group** | ai-data |
| **Icon** | ◑ |
| **Expertise** | BI, lakehouse, data products, semantic layer, self-serve |
...
**Focus Area:** BI, lakehouse, data products, semantic layer, self-serve
...
**Typical invocation:**
`
Orchestrator: "This request needs expertise in BI, lakehouse, data products, semantic layer, self-serve"
Tool: invoke_analytics_agent
