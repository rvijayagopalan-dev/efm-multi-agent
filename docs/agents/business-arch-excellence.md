# Business Architecture Excellence Agent
...
| **Group** | excellence |
| **Icon** | ✧ |
| **Expertise** | Capability modelling, value streams, TOM, BIZBOK |
...
**Focus Area:** Capability modelling, value streams, TOM, BIZBOK
...
**Typical invocation:**
`
Orchestrator: "This request needs expertise in Capability modelling, value streams, TOM, BIZBOK"
Tool: invoke_business_arch_excellence_agent
