...
| **Group** | ai-data |
| **Icon** | 📚 |
| **Expertise** | Knowledge graphs, ontologies, semantic layer, enterprise memory |
...
**Focus Area:** Knowledge graphs, ontologies, semantic layer, enterprise memory
...
**Typical invocation:**
`
Orchestrator: "This request needs expertise in Knowledge graphs, ontologies, semantic layer, enterprise memory"
Tool: invoke_knowledge_agent
...
Other agents in the **ai-data** group may collaborate on comprehensive responses.
