...
| **Icon** | 🔐 |
| **Expertise** | Threat modeling, cryptography, zero-trust, IAM |
...
**Focus Area:** Threat modeling, cryptography, zero-trust, IAM
...
**Typical invocation:**
`
Orchestrator: "This request needs expertise in Threat modeling, cryptography, zero-trust, IAM"
Tool: invoke_security_architecture_agent
