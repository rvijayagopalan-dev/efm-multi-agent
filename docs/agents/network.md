...
| **Group** | cloud-infra |
| **Icon** | 🌐 |
| **Expertise** | Zero-trust, SD-WAN, microsegmentation, DNS, CDN |
...
**Focus Area:** Zero-trust, SD-WAN, microsegmentation, DNS, CDN
...
**Typical invocation:**
`
Orchestrator: "This request needs expertise in Zero-trust, SD-WAN, microsegmentation, DNS, CDN"
Tool: invoke_network_agent
