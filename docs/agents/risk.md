...
| **Group** | governance |
| **Icon** | ⚠️ |
| **Expertise** | Risk registers, threat modelling, BCDR, risk quantification |
...
**Focus Area:** Risk registers, threat modelling, BCDR, risk quantification
...
**Typical invocation:**
`
Orchestrator: "This request needs expertise in Risk registers, threat modelling, BCDR, risk quantification"
Tool: invoke_risk_agent
