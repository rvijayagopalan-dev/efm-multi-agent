...
| **Group** | cloud-infra |
| **Icon** | ● |
| **Expertise** | IDP, golden paths, platform engineering, developer experience |
...
**Focus Area:** IDP, golden paths, platform engineering, developer experience
...
**Typical invocation:**
`
Orchestrator: "This request needs expertise in IDP, golden paths, platform engineering, developer experience"
Tool: invoke_platform_agent
...
Other agents in the **cloud-infra** group may collaborate on comprehensive responses.
