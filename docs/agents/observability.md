...
| **Group** | operations |
| **Icon** | 📊 |
| **Expertise** | Metrics, logs, traces, AIOps, SLOs, alerting |
...
**Focus Area:** Metrics, logs, traces, AIOps, SLOs, alerting
...
**Typical invocation:**
`
Orchestrator: "This request needs expertise in Metrics, logs, traces, AIOps, SLOs, alerting"
Tool: invoke_observability_agent
