...
| **Group** | enterprise |
| **Icon** | 💻 |
| **Expertise** | ADR management, drift detection, policy-as-code |
...
**Focus Area:** ADR management, drift detection, policy-as-code
...
**Typical invocation:**
`
Orchestrator: "This request needs expertise in ADR management, drift detection, policy-as-code"
Tool: invoke_arch_as_code_agent
