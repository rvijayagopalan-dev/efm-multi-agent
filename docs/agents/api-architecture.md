...
| **Icon** | 🔌 |
| **Expertise** | REST, GraphQL, gRPC, API-first, versioning |
...
**Focus Area:** REST, GraphQL, gRPC, API-first, versioning
...
**Typical invocation:**
`
Orchestrator: "This request needs expertise in REST, GraphQL, gRPC, API-first, versioning"
Tool: invoke_api_architecture_agent
