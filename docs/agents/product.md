...
| **Group** | experience |
| **Icon** | 🎯 |
| **Expertise** | Product-led growth, API-first, feature flags, analytics |
...
**Focus Area:** Product-led growth, API-first, feature flags, analytics
...
**Typical invocation:**
`
Orchestrator: "This request needs expertise in Product-led growth, API-first, feature flags, analytics"
Tool: invoke_product_agent
...
Other agents in the **experience** group may collaborate on comprehensive responses.
