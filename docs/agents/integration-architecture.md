...
| **Icon** | 🔗 |
| **Expertise** | EIP, message brokers, event-driven, API gateways |
...
**Focus Area:** EIP, message brokers, event-driven, API gateways
...
**Typical invocation:**
`
Orchestrator: "This request needs expertise in EIP, message brokers, event-driven, API gateways"
Tool: invoke_integration_architecture_agent
