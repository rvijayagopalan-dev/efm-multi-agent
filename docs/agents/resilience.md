...
| **Group** | governance |
| **Icon** | 🛡️ |
| **Expertise** | HA, DR, chaos engineering, fault tolerance |
...
**Focus Area:** HA, DR, chaos engineering, fault tolerance
...
**Typical invocation:**
`
Orchestrator: "This request needs expertise in HA, DR, chaos engineering, fault tolerance"
Tool: invoke_resilience_agent
