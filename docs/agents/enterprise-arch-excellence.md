...
| **Group** | excellence |
| **Icon** | ✦ |
| **Expertise** | EA practice, ARB, TOGAF, maturity, CoE |
...
**Focus Area:** EA practice, ARB, TOGAF, maturity, CoE
...
**Typical invocation:**
`
Orchestrator: "This request needs expertise in EA practice, ARB, TOGAF, maturity, CoE"
Tool: invoke_enterprise_arch_excellence_agent
