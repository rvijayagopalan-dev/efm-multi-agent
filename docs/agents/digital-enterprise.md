...
| **Group** | enterprise |
| **Icon** | ◆ |
| **Expertise** | Digital transformation, operating model, platform business |
...
**Focus Area:** Digital transformation, operating model, platform business
...
**Typical invocation:**
`
Orchestrator: "This request needs expertise in Digital transformation, operating model, platform business"
Tool: invoke_digital_enterprise_agent
