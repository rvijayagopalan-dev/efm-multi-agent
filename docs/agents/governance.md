...
| **Group** | governance |
| **Icon** | ⊕ |
| **Expertise** | EA governance, ARB, decision rights, policy-as-code |
...
**Focus Area:** EA governance, ARB, decision rights, policy-as-code
...
**Typical invocation:**
`
Orchestrator: "This request needs expertise in EA governance, ARB, decision rights, policy-as-code"
Tool: invoke_governance_agent
