...
| **Group** | operations |
| **Icon** | 📡 |
| **Expertise** | IoT platform, device lifecycle, MQTT, edge-cloud integration |
...
**Focus Area:** IoT platform, device lifecycle, MQTT, edge-cloud integration
...
**Typical invocation:**
`
Orchestrator: "This request needs expertise in IoT platform, device lifecycle, MQTT, edge-cloud integration"
Tool: invoke_iot_agent
...
Other agents in the **operations** group may collaborate on comprehensive responses.
