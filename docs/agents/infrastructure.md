...
| **Group** | cloud-infra |
| **Icon** | 📦 |
| **Expertise** | Compute, storage, IaC, automation, GitOps |
...
**Focus Area:** Compute, storage, IaC, automation, GitOps
...
**Typical invocation:**
`
Orchestrator: "This request needs expertise in Compute, storage, IaC, automation, GitOps"
Tool: invoke_infrastructure_agent
