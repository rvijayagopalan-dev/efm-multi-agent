...
| **Group** | experience |
| **Icon** | 📋 |
| **Expertise** | Taxonomy, metadata management, information flows |
...
**Focus Area:** Taxonomy, metadata management, information flows
...
**Typical invocation:**
`
Orchestrator: "This request needs expertise in Taxonomy, metadata management, information flows"
Tool: invoke_information_agent
