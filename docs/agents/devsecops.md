...
| **Group** | operations |
| **Icon** | 🔐 |
| **Expertise** | Secure CI/CD, SBOM, supply chain security, secrets |
...
**Focus Area:** Secure CI/CD, SBOM, supply chain security, secrets
...
**Typical invocation:**
`
Orchestrator: "This request needs expertise in Secure CI/CD, SBOM, supply chain security, secrets"
Tool: invoke_devsecops_agent
