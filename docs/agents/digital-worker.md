...
| **Group** | ai-data |
| **Icon** | ⬠ |
| **Expertise** | AI workforce, human-agent teaming, digital colleague model |
...
**Focus Area:** AI workforce, human-agent teaming, digital colleague model
...
**Typical invocation:**
`
Orchestrator: "This request needs expertise in AI workforce, human-agent teaming, digital colleague model"
Tool: invoke_digital_worker_agent
