...
**Focus Area:** Multi-cloud strategy, landing zones, cloud-native patterns, FinOps, cloud operating model
...
**Typical invocation:**
`
Orchestrator: "This request needs expertise in Multi-cloud strategy, landing zones, cloud-native patterns, FinOps, cloud operating model"
Tool: invoke_cloud_agent
