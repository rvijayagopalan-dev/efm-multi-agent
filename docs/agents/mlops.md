...
| **Group** | ai-data |
| **Icon** | 🔄 |
| **Expertise** | ML pipeline, feature store, model registry, drift detection |
...
**Focus Area:** ML pipeline, feature store, model registry, drift detection
...
**Typical invocation:**
`
Orchestrator: "This request needs expertise in ML pipeline, feature store, model registry, drift detection"
Tool: invoke_mlops_agent
