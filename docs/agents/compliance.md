...
| **Group** | governance |
| **Icon** | ✓ |
| **Expertise** | Regulatory mapping, compliance-as-code, audit |
...
**Focus Area:** Regulatory mapping, compliance-as-code, audit
...
**Typical invocation:**
`
Orchestrator: "This request needs expertise in Regulatory mapping, compliance-as-code, audit"
Tool: invoke_compliance_agent
