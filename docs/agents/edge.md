...
| **Group** | cloud-infra |
| **Icon** | 🔗 |
| **Expertise** | Edge computing, CDN, 5G/MEC, low-latency AI |
...
**Focus Area:** Edge computing, CDN, 5G/MEC, low-latency AI
...
**Typical invocation:**
`
Orchestrator: "This request needs expertise in Edge computing, CDN, 5G/MEC, low-latency AI"
Tool: invoke_edge_agent
