...
**Focus Area:** Multi-agent systems, LLM orchestration, agent frameworks, tool use
...
**Typical invocation:**
`
Orchestrator: "This request needs expertise in Multi-agent systems, LLM orchestration, agent frameworks, tool use"
Tool: invoke_agentic_ai_agent
