...
| **Icon** | ✨ |
| **Expertise** | Lambda, Cloud Functions, state management, cost optimization |
...
**Focus Area:** Lambda, Cloud Functions, state management, cost optimization
...
**Typical invocation:**
`
Orchestrator: "This request needs expertise in Lambda, Cloud Functions, state management, cost optimization"
Tool: invoke_serverless_architecture_agent
