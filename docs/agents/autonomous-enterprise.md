...
| **Group** | enterprise |
| **Icon** | 🤝 |
| **Expertise** | Self-governing systems, AI-driven operations, continuous learning |
...
**Focus Area:** Self-governing systems, AI-driven operations, continuous learning
...
**Typical invocation:**
`
Orchestrator: "This request needs expertise in Self-governing systems, AI-driven operations, continuous learning"
Tool: invoke_autonomous_enterprise_agent
...
Other agents in the **enterprise** group may collaborate on comprehensive responses.
