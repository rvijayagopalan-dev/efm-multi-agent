...
| **Group** | operations |
| **Icon** | 👥 |
| **Expertise** | Digital twin platform, simulation, real-time mirroring |
...
**Focus Area:** Digital twin platform, simulation, real-time mirroring
...
**Typical invocation:**
`
Orchestrator: "This request needs expertise in Digital twin platform, simulation, real-time mirroring"
Tool: invoke_digital_twin_agent
