...
export default function AgentAcademyPage() {
    ...
    return (
      <div className="min-h-screen bg-slate-950 flex items-center justify-center">
        <div className="text-center">
          ...
          <button onClick={() => router.push('/academy-new')} className="text-blue-400 hover:text-blue-300 text-sm">
            ← Back to academy
          </button>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white flex flex-col">
      ...
      <header className="border-b border-slate-800 bg-slate-900/60 backdrop-blur sticky top-0 z-20">
        <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3 min-w-0 flex-1">
            <button
              onClick={() => router.push('/academy-new')}
      ...
      <footer className="border-t border-slate-800 bg-slate-900/40 py-4 px-6">
        <div className="max-w-screen-2xl mx-auto flex items-center justify-between gap-4">
          <div className="text-xs text-slate-500">
            <p>EFM Agentic AI — Enterprise Architecture Learning Academy</p>
          </div>
          <a
